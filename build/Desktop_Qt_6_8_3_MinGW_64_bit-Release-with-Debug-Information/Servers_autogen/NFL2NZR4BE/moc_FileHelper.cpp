...
#include "../../../../src/Tools/FileHelper.h"
...
static constexpr auto qt_meta_stringdata_ZN10FileHelperE = QtMocHelpers::stringData(
    "FileHelper"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10FileHelperE[] = {
...
Q_CONSTINIT const QMetaObject FileHelper::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10FileHelperE.offsetsAndSizes,
    qt_meta_data_ZN10FileHelperE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10FileHelperE_t,
        // Q_OBJECT / Q_GADGET
...
void *FileHelper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10FileHelperE.stringdata0))
